...
public class StudentAdapter extends RecyclerView.Adapter<StudentAdapter.MyViewHolder> {
    ...
    public StudentAdapter(ArrayList<Student> studentArrayList, RecyclerViewClickListener clickListener){
        this.mStudentArrayList = studentArrayList;
    ...
    public void onBindViewHolder( MyViewHolder myViewHolder, int i) {
        myViewHolder.tvName.setText(mStudentArrayList.get(i).getName());
        myViewHolder.tvRoll.setText(mStudentArrayList.get(i).getRoll());
        myViewHolder.tvClass.setText(mStudentArrayList.get(i).getClassName());
    }
